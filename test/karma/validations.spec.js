...
group('Validations | email', function () {
...
group('Validations | Accepted', function () {
...
group('Validations | requiredIf', function () {
...
group('Validations | requiredWithAny', function () {
...
group('Validations | requiredWithAll', function () {
  test('should work fine when none of the targeted fields are present', async function (assert) {
    const data = {}
    const field = 'password'
    const message = 'password is required after username or email'
...
group('Validations | requiredWithoutAny', function () {
...
group('Validations | requiredWithoutAll', function () {
  test('should work fine when all the targeted fields are present', async function (assert) {
    const data = {username: 'foo', email: 'foo@bar.com'}
    const field = 'password'
...
group('Validations | same', function () {
...
group('Validations | equals', function () {
...
group('Validations | notEquals', function () {
...
group('Validations | different', function () {
...
group('Validations | range', function () {
...
group('Validations | min', function () {
...
group('Validations | max', function () {
...
group('Validations | above', function () {
...
group('Validations | under', function () {
...
group('Validations | includes', function () {
...
group('Validations | startsWith', function () {
...
group('Validations | endsWith', function () {
...
group('Validations | regex', function () {
...
group('Validations | alphaNumeric', function () {
...
group('Validations | array', function () {
...
group('Validations | boolean', function () {
...
group('Validations | json', function () {
...
group('Validations | ipv4', function () {
...
group('Validations | ipv6', function () {
...
group('Validations | requiredWhen', function () {
  test('should skip validation when conditional field does not exists', async function (assert) {
    const data = {}
    const field = 'state'
...
group('Validations | Confirmation', function () {
...
group('Validations | String', function () {
